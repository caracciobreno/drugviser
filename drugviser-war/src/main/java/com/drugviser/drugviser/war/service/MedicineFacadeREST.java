...
import com.drugviser.drugviser.entity.persistent.Medicine;
...
public class MedicineFacadeREST extends AbstractFacade<Medicine> {
    ...
    @PersistenceContext(unitName = "drugviser.PU")
    ...
    public Medicine find(@PathParam("id") Long id) {
